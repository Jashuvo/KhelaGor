      ...
      <div className="container mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="md:col-span-1">
            <h2 className="text-3xl font-extrabold text-white">KhelaGhor</h2>
            <p className="mt-2 text-gray-400">Bringing joy to every child.</p>
             <div className="mt-4">
                <p className="font-semibold text-white">Contact Us:</p>
                <p className="text-gray-400">Phone: +880 1XXX-XXXXXX</p>
                <p className="text-gray-400">Email: support@khelaghor.com</p>
            </div>
          </div>
          <div className="grid grid-cols-2 gap-8">
              <div>
                ...
                <ul className="mt-4 space-y-2">
                    ...
                    <li><Link to="#/products" className="text-gray-400 hover:text-white">All Toys</Link></li>
                    <li><Link to="#/account" className="text-gray-400 hover:text-white">My Account</Link></li>
                    <li><Link to="#/admin" className="text-gray-400 hover:text-white">Admin Panel</Link></li>
                </ul>
              </div>
              <div>
          ...
          <div className="md:text-right">
             ...
             <p className="mt-2 text-gray-400">Get updates on new toys and special offers!</p>
             <div className="mt-4 flex rounded-lg border-2 border-gray-600 focus-within:border-white transition-colors">
                <input type="email" placeholder="Enter your email" className="bg-transparent w-full py-2 px-4 focus:outline-none text-white" />
                <button className="bg-yellow-300 text-black font-bold p-2 px-4 rounded-r-md -mr-px border-l-2 border-gray-600">Subscribe</button>
             </div>
          </div>
        </div>
