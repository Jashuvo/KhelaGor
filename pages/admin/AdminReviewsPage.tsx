...
const AdminReviewsPage: React.FC = () => {
    return (
        <AdminCard title="Manage Reviews">
                        ...
                        {REVIEWS.map(review => {
                            ...
                            return (
                                <tr key={review.id}>
                                    ...
                                    <td className="px-6 py-4 text-sm text-gray-500 max-w-sm truncate" title={review.text}>{review.text}</td>
                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{product?.name || 'N/A'}</td>
                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><StarRating rating={review.rating} /></td>
