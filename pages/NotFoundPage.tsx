    ...
    return (
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
             <div className="max-w-md mx-auto bg-white p-8 border-2 border-black rounded-xl shadow-[8px_8px_0px_#000]">
                ...
                <h2 className="text-3xl font-extrabold text-black mt-4">Page Not Found</h2>
                <p className="text-gray-600 mt-2">Oops! The page you are looking for does not exist. It might have been moved or deleted.</p>
                <Link
                    to="#/"
